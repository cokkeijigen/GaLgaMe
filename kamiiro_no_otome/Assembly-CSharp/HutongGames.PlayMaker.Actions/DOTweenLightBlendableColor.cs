...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenLightBlendableColor : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Light>().DOBlendableColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Light Blendable Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

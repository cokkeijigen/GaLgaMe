...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenMaterialColorProperty : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOColor(to.Value, property.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Material Color Property");
			}
			if (finishImmediately.Value)
			{
				Finish();

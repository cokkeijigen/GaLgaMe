...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenImageBlendableColor : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOBlendableColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Image Blendable Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenRectTransformPunchAnchorPos : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOPunchAnchorPos(punch.Value, duration.Value, vibrato.Value, elasticity.Value, snapping.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween RectTransform Punch Anchor Pos");
			}
			if (finishImmediately.Value)
			{
				Finish();

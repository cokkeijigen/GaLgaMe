...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenLineRendererColor : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<LineRenderer>().DOColor(startValue, endValue, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Line Renderer Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

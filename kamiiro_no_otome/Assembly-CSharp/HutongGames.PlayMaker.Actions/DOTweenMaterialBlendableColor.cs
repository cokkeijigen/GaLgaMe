...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenMaterialBlendableColor : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOBlendableColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Material Blendable Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

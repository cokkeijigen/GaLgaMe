...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenTransformBlendableLocalRotateBy : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOBlendableLocalRotateBy(by.Value, duration.Value, rotateMode);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Transform Blendable Local Rotate By");
			}
			if (finishImmediately.Value)
			{
				Finish();

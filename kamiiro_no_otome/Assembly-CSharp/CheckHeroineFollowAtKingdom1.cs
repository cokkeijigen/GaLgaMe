...
[AddComponentMenu("")]
public class CheckHeroineFollowAtKingdom1 : StateBehaviour
{
	...
	{
		if (PlayerDataManager.isDungeonHeroineFollow && PlayerDataManager.DungeonHeroineFollowNum == 4)
		{
			totalMapAccessManager.alertTextLoc.Term = "dialogWorldMapDisable_HateTheKingdom";
			OpenMapAlertDialog();
		}
		else
		{

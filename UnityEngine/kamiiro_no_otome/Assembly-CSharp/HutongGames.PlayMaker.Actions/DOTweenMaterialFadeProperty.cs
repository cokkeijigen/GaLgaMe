...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenMaterialFadeProperty : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFade(to.Value, property.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Material Fade Property");
			}
			if (finishImmediately.Value)
			{
				Finish();

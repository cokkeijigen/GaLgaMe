...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenTransformPunchScale : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOPunchScale(punch.Value, duration.Value, vibrato.Value, elasticity.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Transform Punch Scale");
			}
			if (finishImmediately.Value)
			{
				Finish();

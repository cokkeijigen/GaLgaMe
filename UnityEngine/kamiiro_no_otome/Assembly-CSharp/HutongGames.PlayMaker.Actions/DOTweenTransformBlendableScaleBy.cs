...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenTransformBlendableScaleBy : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOBlendableScaleBy(by.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Transform Blendable Scale By");
			}
			if (finishImmediately.Value)
			{
				Finish();

...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenMaterialBlendableColorProperty : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOBlendableColor(to.Value, property.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Material Blendable Color Property");
			}
			if (finishImmediately.Value)
			{
				Finish();

...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenTextBlendableColor : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Text>().DOBlendableColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Text Blendable Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

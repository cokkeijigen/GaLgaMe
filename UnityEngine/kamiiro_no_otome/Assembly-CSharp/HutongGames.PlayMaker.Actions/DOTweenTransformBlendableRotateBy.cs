...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenTransformBlendableRotateBy : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOBlendableRotateBy(by.Value, duration.Value, rotateMode);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Transform Blendable Rotate By");
			}
			if (finishImmediately.Value)
			{
				Finish();

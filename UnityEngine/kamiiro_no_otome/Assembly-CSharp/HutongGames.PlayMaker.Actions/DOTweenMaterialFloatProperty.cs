...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenMaterialFloatProperty : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFloat(to.Value, property.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Material Float Property");
			}
			if (finishImmediately.Value)
			{
				Finish();

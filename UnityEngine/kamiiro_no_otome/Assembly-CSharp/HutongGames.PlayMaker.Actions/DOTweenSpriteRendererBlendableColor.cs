...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenSpriteRendererBlendableColor : FsmStateAction
	{
		...
		{
			tween = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOBlendableColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				base.State.Debug("DOTween Sprite Renderer Blendable Color");
			}
			if (finishImmediately.Value)
			{
				Finish();

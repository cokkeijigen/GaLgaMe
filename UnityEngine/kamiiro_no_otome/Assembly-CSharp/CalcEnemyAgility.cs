...
[AddComponentMenu("")]
public class CalcEnemyAgility : StateBehaviour
{
	...
	{
		partyNum = GetComponent<ParameterContainer>().GetInt("enemyPartyNum");
		agility = GetComponent<ParameterContainer>().GetInt("enemyAgility");
